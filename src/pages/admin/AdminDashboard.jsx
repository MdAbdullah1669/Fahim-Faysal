...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    document.title = `${data.personalInfo.name || 'Fahim Faysal'} - Portfolio Dashboard`;
    ...
    setPortfolioData({
      ...
      skillsCount: data.skills.technical.length + data.skills.soft.length + data.skills.languages.length,
    ...
    if (storedActivity) {
      ...
      if (sessionActivity) {
        ...
        localStorage.setItem('portfolio_recent_activity', JSON.stringify(defaultActivity));
        sessionStorage.setItem('portfolio_recent_activity', JSON.stringify(defaultActivity));
      }
    }
  }, []);
  ...
  const savePersonalInfoChanges = () => {
    ...
    showNotification('Personal information and hero section saved successfully!');
  ...
  const addEducationEntry = () => {
    ...
    setTimeout(() => {
      const entries = document.querySelectorAll(`.${styles['education-entry']}`);
      if (entries.length > 0) {
  ...
  const deleteHighlightEntry = (index) => {
    ...
    // Log activity
    logActivity('delete', 'Highlights', deletedEntry.title || 'Highlight Entry');
  };
  ...
  const deleteReferenceEntry = (index) => {
    ...
    // Log activity
    logActivity('delete', 'References', deletedReference.name || 'Reference Entry');
  };
  ...
  const saveSkillsChanges = () => {
    ...
    setPortfolioData(prev => ({
      ...prev,
      skillsCount: skillsData.technical.length + skillsData.soft.length + skillsData.languages.length
    }));
  };
  ...
  const handlePasswordChange = () => {
    ...
    const currentPasswordCorrect = passwordHash ? atob(passwordHash) === passwordForm.currentPassword : passwordForm.currentPassword === '1234';
  ...
  const logActivity = (type, section, name = null) => {
    ...
    sessionStorage.setItem('portfolio_recent_activity', JSON.stringify(updatedActivity));
  };
  ...
  return (
    <div className={styles['admin-dashboard']}>
      {/* Side Navigation */}
      <aside className={`${styles['side-nav']} ${sidebarCollapsed ? styles['collapsed'] : ''}`}>
        <div className={styles['side-nav-header']}>
          <div className={styles['profile-image']}>
            {personalInfo.hero?.profileImageUrl ? (
              <img src={personalInfo.hero.profileImageUrl} alt="Admin" id="navProfileImage" />
            ) : (
        ...
        <nav className={styles['side-nav-menu']}>
          ...
          <button 
            className={`${styles['nav-item']} ${activeSection === 'personal' ? styles['active'] : ''}`} 
          ...
          <button 
            className={`${styles['nav-item']} ${activeSection === 'education' ? styles['active'] : ''}`} 
          ...
          <button 
            className={`${styles['nav-item']} ${activeSection === 'experience' ? styles['active'] : ''}`} 
          ...
          <button 
            className={`${styles['nav-item']} ${activeSection === 'skills' ? styles['active'] : ''}`} 
          ...
          <button 
            className={`${styles['nav-item']} ${activeSection === 'highlights' ? styles['active'] : ''}`} 
          ...
          <button 
            className={`${styles['nav-item']} ${activeSection === 'projects' ? styles['active'] : ''}`} 
          ...
          <button 
            className={`${styles['nav-item']} ${activeSection === 'pictures' ? styles['active'] : ''}`} 
          ...
          <button 
            className={`${styles['nav-item']} ${activeSection === 'references' ? styles['active'] : ''}`} 
          ...
          <button 
            className={`${styles['nav-item']} ${activeSection === 'settings' ? styles['active'] : ''}`} 
      ...
      {/* Main Content Area */}
      <main className={`${styles['main-content']} ${sidebarCollapsed ? styles['expanded'] : ''}`}>
        ...
        <header className={styles['dashboard-header']}>
                  ...
                  searchResults.map((result, index) => (
                    ...
                    >
                      <div className={styles['result-icon']}>
                        {result.type === 'project' && <i className="fas fa-code"></i>}
                        {result.type === 'education' && <i className="fas fa-graduation-cap"></i>}
                        {result.type === 'experience' && <i className="fas fa-briefcase"></i>}
                        {result.type === 'skill' && <i className="fas fa-laptop-code"></i>}
                      </div>
                      <div className={styles['result-details']}>
                        <div className={styles['result-title']}>{result.title}</div>
                        <div className={styles['result-subtitle']}>{result.subtitle}</div>
                      </div>
                    </div>
                  ))
                ) : (
          ...
          <div className={styles['header-actions']}>
            <div className={styles['user-profile']} onClick={toggleUserDropdown}>
              <span className={styles['user-name']}>{portfolioData.name}</span>
              <i className={`fas fa-chevron-down ${styles['dropdown-icon']}`}></i>
              <div className={`${styles['user-dropdown']} ${userDropdownOpen ? styles['show'] : ''}`}>
                ...
                <button className={styles['dropdown-item']} onClick={() => changeSection('personal')}>
                  <i className="fas fa-user-circle"></i> Profile
                </button>
                <button className={styles['dropdown-item']} onClick={() => changeSection('settings')}>
        ...
        <div className={styles['data-recovery-notice']} style={{
          ...
          <div>
            <strong>New Data Recovery Feature:</strong> If you notice any data loss, click the life preserver button in the bottom-right corner to restore your data.
          </div>
          <button 
            style={{
              marginLeft: 'auto',
        ...
        <div className={styles['dashboard-content']}>
          {/* Dashboard Home View */}
          <div id="dashboardHome" className={`${styles['content-section']} ${activeSection === 'dashboard' ? styles['active'] : ''}`}>
            <div className={styles['welcome-stats']}>
              <div className={styles['welcome-message']}>
                <h1>Welcome back, <span id="welcomeName">{portfolioData.name.split(' ')[0]}</span>!</h1>
                <p>Here's a summary of your portfolio stats</p>
              </div>
              <div className={styles['stats-cards']}>
                <div className={styles['stat-card']}>
                  <div className={styles['stat-icon']}><i className="fas fa-briefcase"></i></div>
                ...
                <div className={styles['stat-card']}>
                  <div className={styles['stat-icon']}><i className="fas fa-graduation-cap"></i></div>
                  <div className={styles['stat-info']}>
                ...
                <div className={styles['stat-card']}>
                  <div className={styles['stat-icon']}><i className="fas fa-laptop-code"></i></div>
                  <div className={styles['stat-info']}>
                ...
                <div className={styles['stat-card']}>
                  <div className={styles['stat-icon']}><i className="fas fa-eye"></i></div>
                  <div className={styles['stat-info']}>
            ...
            <div className={styles['quick-actions']}>
              ...
              <div className={styles['action-buttons']}>
                <button className={styles['action-btn']} onClick={() => changeSection('projects')}>
                  <i className="fas fa-plus"></i> Add Project
                </button>
                <button className={styles['action-btn']} onClick={() => changeSection('skills')}>
                  <i className="fas fa-plus"></i> Add Skill
                </button>
                <button className={styles['action-btn']} onClick={() => changeSection('education')}>
                  <i className="fas fa-plus"></i> Add Education
                </button>
                <button className={styles['action-btn']} onClick={() => changeSection('pictures')}>
                  ...
                  recentActivity.slice(0, 3).map((activity, index) => (
                    <div className={styles['activity-item']} key={index}>
                      ...
                      <div className={styles['activity-details']}>
                        <p>
                          You {activity.type === 'edit' ? 'updated' : activity.type === 'add' ? 'added' : 'deleted'} 
                          {activity.type === 'add' && activity.name ? ` a new ${activity.section.slice(0, -1)}: ` : ' your '}
                          <strong>
                            {activity.type === 'add' && activity.name ? activity.name : activity.section}
                          </strong>
                        </p>
                        <span className={styles['activity-time']}>{formatRelativeDate(activity.timestamp)}</span>
                      </div>
                    </div>
                  ))
                ) : (
          ...
          <div id="personalEditor" className={`${styles['content-section']} ${activeSection === 'personal' ? styles['active'] : ''}`}>
            <div className={styles['content-editor']}>
              ...
              <div className={styles['editor-content']}>
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Profile & Image</h3>
                  ...
                  <div className={styles['form-group']}>
                    ...
                    <div className={styles['image-upload-container']}>
                      ...
                      <div className={styles['upload-controls']}>
                              ...
                              reader.onload = (event) => {
                                if (typeof event.target?.result === 'string') {
                                  try {
                                    ...
                                    console.log('Image loaded from file selection');
                                    ...
                                    const success = portfolioService.fixHeroImageData(imageUrl);
                                    
                                    if (success) {
                                      // Refresh personal info data
                                      const updatedData = portfolioService.getSectionData('personalInfo');
                                      if (updatedData) {
                                        setPersonalInfo(updatedData);
                                        console.log('Updated personal info state:', updatedData);
                                      }
                        ...
                        />
                        <label htmlFor="heroProfileImage" className={styles['upload-btn']}>
                          ...
                          <button 
                            ...
                            onClick={() => {
                              try {
                                ...
                                const success = portfolioService.fixHeroImageData(null);
                  ...
                  <div className={styles['form-row']}>
                    <div className={styles['form-group']}>
                      ...
                      />
                      <small className={styles['form-helper-text']}>Used in your Hero section, Header and throughout the site</small>
                    </div>
                    <div className={styles['form-group']}>
                      ...
                      />
                      <small className={styles['form-helper-text']}>Appears below your name in the Hero section and Header</small>
                    </div>
                  </div>
                </div>

                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Hero & Header Content</h3>
                  ...
                  <div className={styles['form-group']}>
                    ...
                    />
                    <small className={styles['form-helper-text']}>Appears above your name in the Hero section</small>
                  </div>
                  ...
                  <div className={styles['form-group']}>
                    ...
                    ></textarea>
                    <small className={styles['form-helper-text']}>Will fall back to your introduction if left empty</small>
                  </div>
                  ...
                  <div className={styles['form-group']}>
                    ...
                    />
                    <small className={styles['form-helper-text']}>Text on the call-to-action button in your Hero section</small>
                  </div>
                  
                  <h4 className={styles['form-subsection-title']}>Hero Stats</h4>
                  <p className={styles['form-helper-text']}>These statistics are displayed in your hero section</p>
                    ...
                    <div key={index} className={styles['form-row']}>
                      ...
                      <div className={styles['form-action']}>
                        <button 
                          ...
                          disabled={(personalInfo.hero?.stats || []).length <= 1}
                          title="Delete stat"
                        >
                  ...
                  <div className={styles['form-actions']}>
                    <button 
                      ...
                      onClick={() => {
                        const updatedStats = [...(personalInfo.hero?.stats || []), { value: "", label: "" }];
                        updatePersonalInfo('hero.stats', updatedStats);
                      }}
                    >
                ...
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>About Section</h3>
                  ...
                  <div className={styles['form-group']}>
                    ...
                    <div className={styles['image-upload-container']}>
                      ...
                      <div className={styles['upload-controls']}>
                        ...
                        />
                        <label htmlFor="aboutImage" className={styles['upload-btn']}>
                          <i className="fas fa-upload"></i> Upload Image
                        </label>
                        {personalInfo.aboutImageUrl && (
                          <button 
                            className={`${styles['action-btn']} ${styles['delete']}`}
                            onClick={() => updatePersonalInfo('aboutImageUrl', null)}
                          >
                            <i className="fas fa-trash-alt"></i> Remove
                          </button>
                        )}
                  ...
                  <div className={styles['form-group']}>
                    ...
                    ></textarea>
                    <small className={styles['form-helper-text']}>Displayed in your About section</small>
                  </div>
                </div>
                
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Contact Information</h3>
                  <div className={styles['form-row']}>
                    <div className={styles['form-group']}>
                ...
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Social Media Links</h3>
                  <div className={styles['form-row']}>
                    <div className={styles['form-group']}>
          ...
          {/* Education Section */}
          <div id="educationEditor" className={`${styles['content-section']} ${activeSection === 'education' ? styles['active'] : ''}`}>
            <div className={styles['content-editor']}>
              <div className={styles['editor-header']}>
              ...
              <div className={styles['editor-content']}>
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Education Entries</h3>
                  
                  {educationEntries.length === 0 ? (
                    <div className={styles['no-entries']}>
                      <p>No education entries yet. Click the button below to add your first education entry.</p>
                    </div>
                  ) : (
                        ...
                        <div className={styles['education-entry']} key={index}>
                          <div className={styles['entry-header']}>
                            <h4 className={styles['entry-title']}>
                              {entry.degree ? entry.degree : `Education Entry #${index + 1}`}
                              {entry.institution && <span className={styles['entry-subtitle']}> at {entry.institution}</span>}
                            </h4>
                          ...
                          <div className={styles['form-row']}>
                            ...
                            <div className={styles['form-group']}>
                              ...
                              <div className={styles['checkbox-container']}>
                                ...
                                />
                                <label htmlFor={`currentEducation-${index}`}>Currently studying here</label>
                              </div>
                            </div>
                          </div>
          ...
          {/* Experience Editor */}
          <div id="experienceEditor" className={`${styles['content-section']} ${activeSection === 'experience' ? styles['active'] : ''}`}>
            <div className={styles['content-editor']}>
              <div className={styles['editor-header']}>
              ...
              <div className={styles['editor-content']}>
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Work Experience</h3>
                  <div id="experienceEntries">
                    {experienceEntries.map((entry, index) => (
                      <div className={styles['education-entry']} key={index}>
                        <div className={styles['entry-header']}>
                          <h4 className={styles['entry-title']}>Experience Entry #{index + 1}</h4>
                          <button 
                            className={styles['delete-entry']} 
                        ...
                        <div className={styles['form-row']}>
                          <div className={styles['form-group']}>
                            <label htmlFor={`jobLocation-${index}`}>Location</label>
                            <input 
                              type="text" 
                          ...
                          <div className={styles['form-group']}>
                            <label htmlFor={`employmentPeriod-${index}`}>Period</label>
                            <input 
                              type="text" 
          ...
          {/* Skills Editor */}
          <div id="skillsEditor" className={`${styles['content-section']} ${activeSection === 'skills' ? styles['active'] : ''}`}>
            <div className={styles['content-editor']}>
              <div className={styles['editor-header']}>
                <h2>Edit Skills</h2>
                <div className={styles['editor-actions']}>
              ...
              <div className={styles['editor-content']}>
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Technical Skills</h3>
                  <div id="technicalSkills">
                    {skillsData.technical.map((skill, index) => (
                      <div className={styles['skill-entry']} key={index}>
                        <div className={styles['entry-header']}>
                          <h4 className={styles['entry-title']}>Skill #{index + 1}</h4>
                          <button 
                            className={styles['delete-entry']} 
                ...
                <div className={styles['form-section']}>
                  ...
                  <div id="softSkills">
                    {skillsData.soft.map((skill, index) => (
                      <div className={styles['skill-entry']} key={index}>
                        <div className={styles['entry-header']}>
                          <h4 className={styles['entry-title']}>Soft Skill #{index + 1}</h4>
                          <button 
                            className={styles['delete-entry']} 
                            title="Delete this skill"
                        ...
                        <div className={styles['form-group']}>
                          <label htmlFor={`softSkillName-${index}`}>Skill Name</label>
                          <input 
                            type="text" 
                ...
                <div className={styles['form-section']}>
                  ...
                  <div id="languageSkills">
                    {skillsData.languages.map((skill, index) => (
                      <div className={styles['skill-entry']} key={index}>
                        <div className={styles['entry-header']}>
                          <h4 className={styles['entry-title']}>Language #{index + 1}</h4>
                          <button 
                            className={styles['delete-entry']} 
                        ...
                        <div className={styles['form-row']}>
                          ...
                          <div className={styles['form-group']}>
                            <label htmlFor={`languageLevel-${index}`}>Proficiency Level</label>
                            <select 
          ...
          {/* Highlights Editor */}
          <div id="highlightsEditor" className={`${styles['content-section']} ${activeSection === 'highlights' ? styles['active'] : ''}`}>
            <div className={styles['content-editor']}>
              <div className={styles['editor-header']}>
              ...
              <div className={styles['editor-content']}>
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Career Highlights</h3>
                  <div id="highlightEntries">
                    {highlightEntries.map((entry, index) => (
                      <div className={styles['education-entry']} key={index}>
                        <div className={styles['entry-header']}>
                          <h4 className={styles['entry-title']}>Highlight Entry #{index + 1}</h4>
                          <button 
                            className={styles['delete-entry']} 
                        ...
                        <div className={styles['form-group']}>
                          <label htmlFor={`highlightTitle-${index}`}>Title</label>
                          <input 
                            type="text" 
                            ...
                            value={entry.title}
                            onChange={(e) => updateHighlightEntry(index, 'title', e.target.value)}
                          />
                        </div>
                        
                        <div className={styles['form-row']}>
                          <div className={styles['form-group']}>
                            <label htmlFor={`highlightDate-${index}`}>Date</label>
                            <input 
                              type="month" 
                              id={`highlightDate-${index}`}
                              className={`${styles['form-control']} ${styles['highlightDate']}`} 
                              value={entry.date}
                              onChange={(e) => updateHighlightEntry(index, 'date', e.target.value)}
                            />
                          </div>
                          <div className={styles['form-group']}>
                            <label htmlFor={`highlightCategory-${index}`}>Category</label>
                            <select 
                              id={`highlightCategory-${index}`}
                              className={`${styles['form-control']} ${styles['highlightCategory']}`}
                              value={entry.category}
                              onChange={(e) => updateHighlightEntry(index, 'category', e.target.value)}
                            >
                        ...
                        <div className={styles['form-group']}>
                          <label htmlFor={`highlightDescription-${index}`}>Description</label>
                          <textarea 
                            ...
                            value={entry.description}
                            onChange={(e) => updateHighlightEntry(index, 'description', e.target.value)}
                          ></textarea>
                        </div>
                      </div>
                    ))}
          ...
          {/* Projects Editor */}
          <div id="projectsEditor" className={`${styles['content-section']} ${activeSection === 'projects' ? styles['active'] : ''}`}>
            <div className={styles['content-editor']}>
              <div className={styles['editor-header']}>
                <h2>Edit Projects</h2>
                <div className={styles['editor-actions']}>
              ...
              <div className={styles['editor-content']}>
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Portfolio Projects</h3>
                  <div id="projectEntries">
                    {projectEntries.map((entry, index) => (
                      <div className={styles['project-entry']} key={index}>
                        <div className={styles['entry-header']}>
                          <h4 className={styles['entry-title']}>Project Entry #{index + 1}</h4>
                          <button 
                            className={styles['delete-entry']} 
                        ...
                        <div className={styles['form-row']}>
                          ...
                          <div className={styles['form-group']}>
                            <label htmlFor={`projectCategory-${index}`}>Category</label>
                            <input 
                              type="text" 
                              ...
                              value={entry.category}
                              onChange={(e) => updateProjectEntry(index, 'category', e.target.value)}
                            />
                          </div>
                        </div>
                        ...
                        <div className={styles['form-row']}>
                          <div className={styles['form-group']}>
                            ...
                            <div className={styles['image-upload-container']}>
                              ...
                              <div className={styles['upload-controls']}>
                                <input 
                                  ...
                                  onChange={(e) => {
                                    if (e.target.files && e.target.files[0]) {
                                      ...
                                      reader.onload = (event) => {
                                        if (typeof event.target?.result === 'string') {
                                          updateProjectEntry(index, 'image', event.target.result);
                                          showNotification(`Image for ${entry.title} updated successfully!`);
                                        }
                                      };
                                      reader.readAsDataURL(file);
                                    }
                                ...
                                />
                                <label htmlFor={`projectImage-${index}`} className={styles['upload-btn']}>
                                  <i className="fas fa-upload"></i> Upload Image
                                </label>
                                {entry.image && (
                                  <button 
                                    className={`${styles['action-btn']} ${styles['delete']}`}
                                    onClick={() => updateProjectEntry(index, 'image', null)}
                                  >
                                    <i className="fas fa-trash-alt"></i> Remove
                                  </button>
                                )}
                          ...
                          <div className={styles['form-group']}>
                            <label htmlFor={`projectDemo-${index}`}>Demo URL</label>
                            <input 
                              type="url" 
                              ...
                              value={entry.demoUrl}
                              onChange={(e) => updateProjectEntry(index, 'demoUrl', e.target.value)}
                            />
                          </div>
                        </div>
                        ...
                        <div className={styles['form-row']}>
                          <div className={styles['form-group']}>
                            <label htmlFor={`projectRepo-${index}`}>Repository URL</label>
                            <input 
                              type="url" 
                              ...
                              value={entry.repoUrl}
                              onChange={(e) => updateProjectEntry(index, 'repoUrl', e.target.value)}
                            />
                          </div>
                          <div className={styles['form-group']}>
                            <label htmlFor={`projectDate-${index}`}>Completion Date</label>
                            <input 
                              type="month" 
                              id={`projectDate-${index}`}
                              className={`${styles['form-control']} ${styles['projectDate']}`} 
                              value={entry.date}
                              onChange={(e) => updateProjectEntry(index, 'date', e.target.value)}
                            />
                          </div>
                        </div>
                        
                        <div className={styles['form-group']}>
                          <label htmlFor={`projectTechnologies-${index}`}>Technologies Used</label>
                          <input 
                            type="text" 
                            ...
                            onChange={(e) => updateProjectEntry(index, 'technologies', e.target.value)}
                          />
                        </div>
                      </div>
                    ))}
          ...
          {/* Pictures Editor */}
          <div id="picturesEditor" className={`${styles['content-section']} ${activeSection === 'pictures' ? styles['active'] : ''}`}>
            <div className={styles['content-editor']}>
              <div className={styles['editor-header']}>
                <h2>Edit Pictures</h2>
                <div className={styles['editor-actions']}>
              ...
              <div className={styles['editor-content']}>
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Photography Collection</h3>
                  <div id="pictureEntries">
                    {pictureEntries.map((entry, index) => (
                      <div className={styles['education-entry']} key={index}>
                        <div className={styles['entry-header']}>
                          <h4 className={styles['entry-title']}>Picture Entry #{index + 1}</h4>
                          <button 
                            className={styles['delete-entry']} 
                        ...
                        <div className={styles['form-row']}>
                          <div className={styles['form-group']}>
                            <label htmlFor={`pictureTitle-${index}`}>Title</label>
                            <input 
                              type="text" 
                              ...
                              value={entry.title}
                              onChange={(e) => updatePictureEntry(index, 'title', e.target.value)}
                            />
                          </div>
                          <div className={styles['form-group']}>
                            <label htmlFor={`pictureCategory-${index}`}>Category</label>
                            <input 
                              type="text" 
                              ...
                              value={entry.category}
                              onChange={(e) => updatePictureEntry(index, 'category', e.target.value)}
                            />
                          </div>
                        </div>
                        
                        <div className={styles['form-group']}>
                          <label htmlFor={`pictureDescription-${index}`}>Description</label>
                          <textarea 
                            ...
                            value={entry.description}
                            onChange={(e) => updatePictureEntry(index, 'description', e.target.value)}
                          ></textarea>
                        </div>
                        
                        <div className={styles['form-row']}>
                          <div className={styles['form-group']}>
                            <label htmlFor={`pictureImage-${index}`}>Image</label>
                            <div className={styles['image-upload-container']}>
                              <div className={styles['current-image']}>
                                {entry.image ? (
                                  <img 
                              ...
                              <div className={styles['upload-controls']}>
                                <input 
                                  ...
                                  onChange={(e) => {
                                    if (e.target.files && e.target.files[0]) {
                                      ...
                                      reader.onload = (event) => {
                                        if (typeof event.target?.result === 'string') {
                                          updatePictureEntry(index, 'image', event.target.result);
                                          showNotification(`Image for ${entry.title} updated successfully!`);
                                        }
                                      };
                                      reader.readAsDataURL(file);
                                ...
                                />
                                <label htmlFor={`pictureImage-${index}`} className={styles['upload-btn']}>
                                  <i className="fas fa-upload"></i> Upload Image
                                </label>
                                {entry.image && (
                                  <button 
                                    className={`${styles['action-btn']} ${styles['delete']}`}
                                    onClick={() => updatePictureEntry(index, 'image', null)}
                                  >
                                    <i className="fas fa-trash-alt"></i> Remove
                                  </button>
                                )}
                          ...
                          <div className={styles['form-group']}>
                            <label htmlFor={`pictureLink-${index}`}>Full Size Link</label>
                            <input 
                              type="url" 
                              ...
                              value={entry.link}
                              onChange={(e) => updatePictureEntry(index, 'link', e.target.value)}
                            />
                          </div>
                        </div>
                      </div>
          ...
          {/* References Editor */}
          <div id="referencesEditor" className={`${styles['content-section']} ${activeSection === 'references' ? styles['active'] : ''}`}>
            <div className={styles['content-editor']}>
              <div className={styles['editor-header']}>
              ...
              <div className={styles['editor-content']}>
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Professional References</h3>
                  <div id="referenceEntries">
                    {referenceEntries.map((entry, index) => (
                      <div className={styles['education-entry']} key={index}>
                        <div className={styles['entry-header']}>
                          <h4 className={styles['entry-title']}>Reference Entry #{index + 1}</h4>
                          <button 
                            className={styles['delete-entry']} 
                        ...
                        <div className={styles['form-row']}>
                          <div className={styles['form-group']}>
                            ...
                            <input 
                              ...
                              value={entry.name}
                              onChange={(e) => updateReferenceEntry(index, 'name', e.target.value)}
                            />
                          </div>
                          <div className={styles['form-group']}>
                            ...
                            <input 
                              ...
                              placeholder="e.g. CTO" 
                              value={entry.position}
                              onChange={(e) => updateReferenceEntry(index, 'position', e.target.value)}
                            />
                          </div>
                        </div>
                        ...
                        <div className={styles['form-row']}>
                          ...
                          <div className={styles['form-group']}>
                            <label htmlFor={`referenceImage-${index}`}>Image</label>
                            <div className={styles['image-upload-container']}>
                              <div className={styles['current-image']}>
                                {entry.image ? (
                                  <img 
                              ...
                              <div className={styles['upload-controls']}>
                                <input 
                                  ...
                                  onChange={(e) => {
                                    if (e.target.files && e.target.files[0]) {
                                      ...
                                      reader.onload = (event) => {
                                        if (typeof event.target?.result === 'string') {
                                          updateReferenceEntry(index, 'image', event.target.result);
                                          showNotification(`Image for ${entry.name} updated successfully!`);
                                        }
                                      };
                                      reader.readAsDataURL(file);
                                    }
                                ...
                                />
                                <label htmlFor={`referenceImage-${index}`} className={styles['upload-btn']}>
                                  <i className="fas fa-upload"></i> Upload Image
                                </label>
                                {entry.image && (
                                  <button 
                                    className={`${styles['action-btn']} ${styles['delete']}`}
                                    onClick={() => updateReferenceEntry(index, 'image', null)}
                                  >
                                    <i className="fas fa-trash-alt"></i> Remove
                                  </button>
                                )}
                        ...
                        <div className={styles['form-group']}>
                          <label htmlFor={`referenceQuote-${index}`}>Quote</label>
                          <textarea 
                            ...
                            value={entry.quote}
                            onChange={(e) => updateReferenceEntry(index, 'quote', e.target.value)}
                          ></textarea>
                        </div>
                      </div>
                    ))}
          ...
          {/* Settings Editor */}
          <div id="settingsEditor" className={`${styles['content-section']} ${activeSection === 'settings' ? styles['active'] : ''}`}>
            <div className={styles['content-editor']}>
              <div className={styles['editor-header']}>
                <h2>Settings</h2>
                <div className={styles['editor-actions']}>
              ...
              <div className={styles['editor-content']}>
                {/* Account Settings */}
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Account Settings</h3>
                  ...
                  <div className={styles['form-group']}>
                    ...
                    <input 
                      ...
                      onChange={(e) => updateAuthSettings('username', e.target.value)}
                    />
                  </div>
                  ...
                  <div className={styles['form-group']}>
                    ...
                    <input 
                      ...
                      onChange={(e) => updateAuthSettings('email', e.target.value)}
                    />
                  </div>
                </div>
                ...
                {/* Password Change */}
                <div className={styles['form-section']}>
                  <h3 className={styles['form-section-title']}>Change Password</h3>
